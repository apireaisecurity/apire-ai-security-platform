...
- [x] **Configuration Refinement**
  - [x] Enhance `devcontainer.json` with port labels and descriptions
  - [x] Add VS Code extensions for Kubernetes, Docker, and ESLint
- [x] **Automation**
  - [x] Create `scripts/setup-codespace.sh` for robust initialization
  - [x] Configure `postCreateCommand` to use the setup script
  - [x] Add `postStartCommand` to print a welcome message with service URLs
- [x] **Debugging**
  - [x] Create `.vscode/launch.json` for debugging Node.js services
  - [x] Add compound launch configurations to start multiple services
- [x] **Documentation**
  - [x] Create `docs/CODESPACES.md` with a step-by-step guide
  - [x] Add "Open in GitHub Codespaces" badge to `README.md`
