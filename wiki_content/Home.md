...
|------|----------|---------------|
| **[☁️ GitHub Codespaces](Getting-Started#-quick-start-github-codespaces)** | Quick testing, no setup | 2 minutes |
| **[💻 Local Installation](Getting-Started#-local-installation)** | Development, customization | 15 minutes |
| **[🐳 Docker Deployment](Deployment#docker-deployment)** | Single-server production | 30 minutes |
| **[☸️ Kubernetes](Deployment#kubernetes-deployment)** | Enterprise, high-availability | 1-2 hours |

## 📖 Documentation

### Quick Links
- 📐 **[Architecture Overview](Architecture-Overview)**: Understand the microservices design
...
- 🐛 **Report Bugs**: [Open an issue](https://github.com/apireaisecurity/apire-ai-security-platform/issues)
- 💡 **Request Features**: Share your ideas
- 🔧 **Submit PRs**: Help us build
