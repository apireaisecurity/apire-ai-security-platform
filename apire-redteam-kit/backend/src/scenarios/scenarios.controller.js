...
let ScenariosController = (() => {
    let _classDecorators = [(0, common_1.Controller)("scenarios")];
    ...
    var ScenariosController = _classThis = class {
        constructor(scenariosService) {
            this.scenariosService = (__runInitializers(this, _instanceExtraInitializers), scenariosService);
        }
        findAll() {
    ...
    __setFunctionName(_classThis, "ScenariosController");
    (() => {
        ...
        ScenariosController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ScenariosController = _classThis;
})();
